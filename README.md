...
## Workflow overview
    ...
    8. Run sohpacker.py to package textures, text and audio into an OTR or O2R mod file
...
### sohpacker.py
Packages translated textures, text and audio into an `.otr` or `.o2r` archive for use with [Ship of Harkinian](https://github.com/HarbourMasters/Shipwright). Reads a decompressed ROM from `roms/Tidens_okarina-PALOTR.z64` and a TOML manifest from `extrsettings/OTRPacker.toml`, then writes the finished archive to `klara/Svenska.o2r` by default.
...
## Folder structure
    ...
    audio/
      ...
      soh/
        Navi - Hello!_META              Binary audio resources
